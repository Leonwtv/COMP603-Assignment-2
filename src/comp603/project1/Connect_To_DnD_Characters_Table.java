...
public class Connect_To_DnD_Characters_Table extends javax.swing.JFrame {
...
ResultSet rs;
    ...
    public Connect_To_DnD_Characters_Table() {
    ...
    private void comboBox(){
     ...
     try
     {
         con = DriverManager.getConnection("jdbc:derby://localhost:1527/DnD_Characters_Database", "username", "password");
         String sql = "select * from DND_CHARCACTERS_TABLE ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Connect_To_DnD_Characters_Table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Connect_To_DnD_Characters_Table().setVisible(true);
            }
        });
    }
